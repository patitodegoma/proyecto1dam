 ...
 * @author andres
 */
public class ProfesoresBuscar extends javax.swing.JPanel {

    /**
     * Creates new form ProfesoresForm
     */
    public ProfesoresBuscar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        buscarLabel.setText("Buscar Profesor (para modificarlo, borrarlo, ...)");
        buscarPanel.add(buscarLabel);
        buscarLabel.setBounds(23, 12, 760, 14);
        ...
        jButton1.setBounds(700, 100, 90, 90);
        ...
        masOpcionesLabel.setBounds(23, 12, 760, 14);
